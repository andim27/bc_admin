        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="col-xs-12">
                    ...
                    <?= $form->field($model, 'name')->textInput(['class' => 'form-control name_usr_prof', 'id' => 'user-firstname',  'name' => 'name'])->label(false) ?>
            ...
            <div class="col-md-6">
                ...
                <div class="col-xs-12">
                    ...
                    <?= $form->field($model, 'surname')->textInput(['class' => 'form-control surname_usr_prof', 'id' => 'user-secondname', 'name' => 'surname'])->label(false) ?>
                    <div class="help-block"></div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="col-xs-12">
                    ...
                    <?= $form->field($model, 'mobile')->textInput(['maxlength' => 16, 'class' => 'form-control mobile_usr_prof', 'name' => 'mobile'])->label(false) ?>
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="col-xs-12">
                    ...
                    <?= $form->field($model, 'smobile')->textInput(['maxlength' => 16, 'class' => 'form-control smobile_usr_prof', 'name' => 'smobile'])->label(false) ?>
                    <div class="help-block"></div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="col-xs-12">
                    ...
                    <?= $form->field($model, 'state')->textInput(['class' => 'form-control', 'id' => 'usr_state_here', 'name' => 'state'])->label(false) ?>
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="col-xs-12">
                    ...
                    <?= $form->field($model, 'city')->textInput(['class' => 'form-control', 'id' => 'usr_city_here', 'name' => 'city'])->label(false) ?>
                    <div class="help-block"></div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="col-xs-12">
                    ...
                    <?= $form->field($model, 'address')->textInput(['class' => 'form-control user-address', 'id' => 'user-address', 'name' => 'address'])->label(false) ?>
                    <div class="help-block"></div>
                </div>
            </div>
        </div>
...
<?php $this->registerJsFile('//maps.google.com/maps/api/js?sensor=false'); ?>
<?php $this->registerJsFile('/js/maps/gmaps.js'); ?>
<?php $this->registerJsFile('/js/main/business_profile.js'); ?>
<?php $this->registerJsFile('/js/main/business_profile_save.js'); ?>
