...
$this->title = THelper::t('editing_administrator').': '.$model->second_name.' '.$model->name.' '.$model->middle_name;
$this->params['breadcrumbs'][] = ['label' => THelper::t('administrators'), 'url' => ['index']];
//$this->params['breadcrumbs'][] = ['label' => $model->login, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = THelper::t('editing_administrator');
?>
<script>
