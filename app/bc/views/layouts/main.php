  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top">
      <div class="navbar-header aside-md">
        ...
        <?= Html::a( '<img alt ="logo admin" src= "/images/logo1.png" width = "" height = "" />', ['/site/index'], ['class' => 'navbar-brand']) ?>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <span class="thumb-sm avatar pull-left">
              <?php
              if(Yii::$app->user->identity['avatar_img'] != ''){
                $ava = '/uploads/'. Yii::$app->user->identity['avatar_img'];
              } else $ava = '/images/avatar_default.png';
              ?>
              <img src="<?= $ava ?>">
            </span>
            <?= Yii::$app->session->get('firstName') ?> <?= Yii::$app->session->get('secondName')  ?> <b class="caret"></b>
          </a>
...
<?php $this->endPage() ?>
<!--<div class="nomonitor_debug">
<?php /* echo LangswitchWidget::widget() */?>
</div>-->
