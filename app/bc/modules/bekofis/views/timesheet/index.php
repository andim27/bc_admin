...
$this->title = THelper::t('timesheet');
...
?>
    ...
    <section class="hbox stretch">
        <aside id="subNav" class="aside-md bg-white b-r">
            <div class="wrapper b-b header"><?=THelper::t('choose_your_language')?><!--Выбор языка--></div>
            <ul class="nav">
                <?php
        ...
        <aside class="f">
            <div class="header b-b clearfix panel panel-default"><?=THelper::t('schedule_online_conferences')?><!--Расписание онлайн-конференций--></div>
        </aside>
    </section>

<?php $this->registerJsFile('js/main/timesheet.js',['depends'=>['app\assets\AppAsset']]); ?>
