...
?>
    ...
    <section class="hbox stretch">
        ...
        <aside class="f">
            <div class="header b-b clearfix panel panel-default"><?=THelper::t('career_plan')?><!--Карьерный план--></div>
        </aside>
    </section>

<?php $this->registerJsFile('js/main/carrier.js',['depends'=>['app\assets\AppAsset']]); ?>
