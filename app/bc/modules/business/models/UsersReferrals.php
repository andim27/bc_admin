            ...
            if ($row->parentId == $pid) {
                ...
                $r .= '
                    <div class="col-sm-6" style="padding: 0">
                        <div class="children panel o-h ' . $class . ' bg-deleted' . intval($row->isDeleted) . '" data-side="' . $row->side . '" data-lvl="' . $counter . '" parent-id="' . $row->parentId . '" data-id="' . $row->id . '">
                            ...
                            <p class="steps text-right col-md-12" style="margin-top: -28px;">' . $row->statistics->steps . '</p>
                        </div>';
                Yii::$app->params['number'] ++;
                unset($arr[$n]);
