...
<div class="main_block">
    <div class="children panel o-h bg-danger bg-deleted<?= intval($current_user_model->isDeleted) ?>"
...
<!--        <div class="add_info hidden">
        ...
        <p class="steps text-right col-md-12" style="margin-top: -28px;"><?=$current_user_model->statistics->steps ?></p>
    </div>
    <?= $tree; ?>
