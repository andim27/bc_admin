...
<div class="row">
    <div class="col-md-4">
        ...
        <section class="panel">
            <div class="text-center wrapper bg-light lt">
                <div class="sparkline-index inline" data-type="pie" data-height="165" data-slice-colors="['#77c587','#41586e']">
...
<div class="row">
    <?php if (isset($user->sponsor) && $user->sponsor) { ?>
        <div class="col-md-6">
            <section class="panel panel-info">
                <div class="panel-body">
                    <a href="#" class="thumb pull-right m-l"><img src="<?= $user->sponsor->avatar ? $user->sponsor->avatar : '/images/avatar_default.png'; ?>" class="img-circle"></a>
                    <div class="clear">
                        <small class="block text-muted"><?= THelper::t('user_info_sponsor_login') . ': ' . $user->sponsor->username ?></small>
                        <small class="block text-muted"><?= $user->sponsor->firstName ?> <?= $user->sponsor->secondName ?></small>
    ...
    <div class="col-md-6">
        <section class="panel panel-info">
            <div class="panel-body">
                <a href="#" class="thumb pull-right m-l"><img src="<?= $parent->avatar ? $parent->avatar : '/images/avatar_default.png'; ?>" class="img-circle"></a>
                <div class="clear">
                    <small class="block text-muted"><?= THelper::t('user_info_parent_login') . ': ' . $parent->username ?></small>
                    <small class="block text-muted"><?= $parent->firstName ?> <?= $parent->secondName ?></small>
                    ...
                    <?php if ($upSpilovers) {
                        foreach ($upSpilovers as $upSpilover) { ?>
                            <tr>
                                ...
                                <td>
                                    <?= THelper::t('left') ?>: <?= $upSpilover->leftSideNumberUsers ?>, <?= THelper::t('right') ?>: <?= $upSpilover->rightSideNumberUsers ?>
                                </td>
                                <td>
...
<?php } else { ?>
    <div class="alert alert-danger"> <button type="button" class="close" data-dismiss="alert">×</button> <i class="fa fa-ban-circle"></i><?= THelper::t('user_info_not_found') ?></div>
<?php } ?>