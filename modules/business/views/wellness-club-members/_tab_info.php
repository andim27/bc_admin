    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-3 m-b-md">
                <?= Html::dropDownList('language', $selectedLanguage, $translationList, ['id' => 'languages-list', 'class' => 'form-control']) ?>
            </div>
...
<script>
    $('#languages-list').change(function() {
        window.location.replace('/' + LANG + '/business/wellness-club-members?l=' + $(this).val());
    });
    tinymce.init({
        selector: 'textarea',
