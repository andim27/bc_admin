...
<div class="m-b-md">
    <h3 class="m-b-none"><?= THelper::t('sidebar_report_charges_representative') ?></h3>
</div>
<div class="row">

    <?php $formStatus = ActiveForm::begin([
        'action' => '/' . $language . '/business/sale-report/report-charges-representative',
    ...
    <div class="col-md-offset-5 col-md-2 m-b">
