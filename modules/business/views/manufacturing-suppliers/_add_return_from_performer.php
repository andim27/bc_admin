...
<div class="modal-dialog popupPostingOrder">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?= THelper::t('return_from_performer') ?></h4>
        </div>

        <div class="modal-body">
            <?php $formCom = ActiveForm::begin([
                'action' => '/' . $language . '/business/manufacturing-suppliers/save-return-performer',
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12 text-left">
                        ...
                        <?=Html::input('text','comment', 'Возврат:',[
                            'class'=>'form-control',
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <?= Html::submitButton(THelper::t('posting_return'), ['class' => 'btn btn-success']) ?>
                </div>
            </div>
            <?php ActiveForm::end(); ?>
