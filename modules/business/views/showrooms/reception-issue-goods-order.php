                                    ...
                                    <?php foreach($salesShowroom as $itemSale){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="editOrder m-l" href="#editOrder" data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                            </td>
                                            ...
                                            <td>
                                                <a class="showComment m-l" href="#showComment" data-toggle="modal" data-sale-id="<?=$itemSale['saleId']?>">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
