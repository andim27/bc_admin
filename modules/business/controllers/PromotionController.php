...
class PromotionController extends BaseController
{
    ...
    public function actionCurrent()
    {
        return $this->render('current', [
            ...
            'promos22' => Promos::find()->where(['type' => 'TYPE_DUBAI_010418', 'category2' => 2, 'completed' => true])->orderBy(['completed2' => SORT_DESC, 'date2' => SORT_DESC])->all(),
            'promos32' => Promos::find()->where(['type' => 'TYPE_DUBAI_010418', 'category2' => 3, 'completed' => true])->orderBy(['completed2' => SORT_DESC, 'date2' => SORT_DESC])->all(),
            'promos42' => Promos::find()->where(['type' => 'TYPE_DUBAI_010418', 'category2' => 4, 'completed' => true])->orderBy(['completed2' => SORT_DESC, 'date2' => SORT_DESC])->all(),
        ]);
    }
