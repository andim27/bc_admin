...
//                        }
    ...
    {
        $goods = [
            'Микросхема BQ2057CTS',
            'Микросхема TPS76333DBV',
            'Микросхема STM32F103RET6',
            'Микросхема STM32F103RCT6',
            'Микросхема STM32F103С8',
            'Микросхема SN74HC04PW tssop-14',
            'Микросхема SN74HC04D so-14',
            'Микросхема 74LVC244APW',
            'Микросхема AD9833BRM',
            'Микросхема MAX1797EUA',
            'Микросхема MAX1796EUA',
            'Микросхема NCP1403SNT1',
            'Микросхема 74HC164D(SO-14)',
            'Микросхема 74HC00D(SO-14)',
            'Резонатор HC-49/US-F-30-30-В-32 8 МГц SMD',
            'Резонатор KX-327NHT-12.80116 32,768 kГц SMD',
            '(FC-135 3215-32.768KHz resonator SMD  EPSON)',
            'KXO-V97(27 MHz)',
            'Конденсатор TAJ-A-106M-010R  10 мкФ-20%-10 В',
            'Конденсатор TAJ-A-476M-010R  47(33) мкФ-20%-10 В',
            'Конденсатор TAJ-A-226M-010R   22 мкФ-20%-10 В',
            'Конденсатор 0805-NPO-27(30) пФ-5%-50 В',
            'Конденсатор 0805- NPO-12(10) пФ-5%-50 В 6,8 pF(7,5pF)',
            'Конденсатор 0805-X7R-0,01 мкФ-5%-50 В',
            'Конденсатор 0805-X7R-0,1 мкФ-5%-50 В',
            'Конденсатор 0805-X7R-0,015 мкФ-5%-50 В',
            'Конденсатор 0805-X7R-2.2 мкФ-5%-50 В',
            'Конденсатор 0805- NPO-30 пФ-5%-50 В',
            'Конденсатор 0805- NPO-47 пФ-5%-50 В',
            'Конденсатор 0805- NPO-68 пФ-5%-50 В',
            'Конденсатор 1206 -X7R-1нФ-5%-50 В',
            'Конденсатор 1210-X7R-1 мкФ-10%-16 В',
            'Гнездо дисплея 8 Gb FPC',
            'Гнездо дисплея 2 Gb FPC',
            'Дроссель CDRH4D18NP- 220(330), (22-33 мкГн)',
            'Резистор 0805-470 Ом-5%',
            'Резистор 0805-33 кОм-5%',
            'Резистор 0805-3,3 кОм-5%',
            'Резистор 0805-0,68(1) Ом-5%',
            'Резистор 0805-0,33 Ом-5%',
            'Резистор 0805-1 кОм-5%',
            'Резистор 0805-100 Ом-5%',
            'Резистор 0805-680 Ом-5%',
            'Резистор 0805-22(27) Ом-5%',
            'Резистор 0805-10 кОм-5%',
            'Резистор 0805-100 кОм-5%',
            'Резистор 0805-2,2 кОм-5%',
            'Резистор 0805-1,3 кОм-5%',
            'Резистор 0805-36 Ом-5%',
            'Резистор 0805-91 кОм-5%',
            'Резистор 0805-1,5 кОм-5%',
            'Резистор 0805-470 Ом-5%',
            'Резистор 0805-330(390) Ом-5%',
            'Резистор 0805-300 Ом-5%',
            'Резистор 0805-560 Ом-5%',
            'Резистор 0805-910 кОм-5%',
            'Ограничитель импульсных напряжения NUP2201MR6T1',
            'BS-С346RD',
            '3*7 индикатор',
            'Диод BAV99WT1',
            'Диод 1N4148',
            ...
            'Диод US1M',
            'BAT54SW',
            'Стабилитрон BZX84C13LT1G',
            'Светодиод белый диам.5мм',
            'Светодиод  0805 - синий',
            'Светодиод  0805 - желтый',
            'Светодиод  0805 - зеленый',
            'Транзистор MMBT3904TT1G',
            'Транзистор BCP69T1G',
            'Транзистор BC847С',
            'Tранзистор IRLL014',
        ...
        foreach($goods as $item){
            if(empty(PartsAccessories::findOne(['title'=>$item]))){
